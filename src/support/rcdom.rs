...
//! IMPORTANT - Copied from html5ever markup5ever_rcdom due to
//!             type mismatch with the latest html5ever
//! source ref: https://github.com/servo/html5ever/blob/main/rcdom/lib.rs
